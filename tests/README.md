...
git worktree add /tmp/macsym-php <commit>
# aponte /tmp/macsym-php/api/config.php para o mesmo banco do .env
php -S 127.0.0.1:8000 -t dist /tmp/macsym-php/scripts/dev-server.php &
npm run start:build &
