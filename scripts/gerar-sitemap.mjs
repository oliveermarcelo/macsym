 ...
 *   SITE_URL=https://camerasdevideo.com.br \
 *   API_URL=https://camerasdevideo.com.br/api npm run gerar:sitemap
 */
...
const SITE = (process.env.SITE_URL ?? 'https://camerasdevideo.com.br').replace(/\/+$/, '');
