        ...
        {cartItems.length === 0 ? (
          ...
          <div className="flex-1 flex flex-col items-center justify-center text-center px-8">
            ...
            <p className="text-sm text-gray-400 max-w-xs leading-relaxed mb-6">
              Escolha câmeras, microfones e acessórios e adicione à sua sacola.
            </p>
            <button
              onClick={onClose}
          ...
          <>
            ...
            <div className="bg-white border-t border-gray-100 px-5 pt-4 pb-5 flex-shrink-0 space-y-3">
              ...
              <button
                ...
                className="w-full py-4 bg-brand-red hover:bg-[#9c1822] text-white font-bold text-sm uppercase tracking-wider rounded-xl transition-all flex items-center justify-center gap-2 shadow-md active:scale-[0.98] cursor-pointer"
              >
                Finalizar compra
