...
const ESTILO = {
  ...
  customVariables: {
    ...
    baseColor: '#24282e', // grafite estrutural da Macsym
    baseColorFirstVariant: '#1a1f25',
    baseColorSecondVariant: '#f7f8fa',
        ...
        const ctrl = await mp.bricks().create('cardPayment', CONTAINER, {
          ...
          callbacks: {
            ...
            onError: (erro: { message?: string }) => {
               ...
               */
              console.error('[macsym] erro no formulário de cartão:', erro);
