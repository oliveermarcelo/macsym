      ...
      <div className="bg-primary-blue text-white text-[11px] sm:text-xs font-medium">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-8 flex items-center justify-center gap-2">
          ...
          <span className="tracking-wide">
            <strong className="font-bold">Equipamento profissional de áudio e vídeo</strong> • Enviamos para todo o Brasil
          </span>
        </div>
      </div>
            ...
            <div className="hidden md:flex flex-1 max-w-xl mx-auto">
              <div className="relative w-full">
                ...
                <input
                  ...
                  type="text"
                  placeholder="O que você procura hoje? Ex: câmera PTZ, microfone lapela, mesa controladora..."
                  value={searchQuery}
