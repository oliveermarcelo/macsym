      ...
      >
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <button
            type="submit"
            disabled={busy}
            className="w-full py-3 bg-brand-red hover:bg-[#9c1822] disabled:opacity-60 text-white font-bold text-xs uppercase tracking-widest rounded-lg transition-colors shadow-sm inline-flex items-center justify-center gap-2"
          >
