                ...
                {step < 3 ? (
                  ...
                  paymentMethod === 'pix' && (
                    <button
                      ...
                      className="inline-flex items-center gap-2 px-8 py-3.5 bg-brand-red hover:bg-[#9c1822] text-white rounded-full text-sm font-bold uppercase tracking-wider transition-all shadow-md active:scale-[0.98] disabled:opacity-60"
                    >
                      {isSubmitting ? (
