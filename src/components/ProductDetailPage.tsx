        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
          ...
          <div className="lg:col-span-6 lg:sticky lg:top-44 space-y-5">
            <div className="group relative bg-gradient-to-br from-white via-white to-gray-50/80 rounded-3xl border border-gray-150 p-8 sm:p-14 flex items-center justify-center shadow-[0_8px_40px_rgba(43,49,37,0.07)] overflow-hidden min-h-[380px] sm:min-h-[520px]">
              ...
              <div className="absolute -bottom-20 -left-10 w-56 h-56 rounded-full bg-brand-accent-300/[0.06] blur-3xl" />
            ...
            */}
                ...
                {fotos.map((foto, i) => (
                  <button
                    ...
                    className={`w-16 h-16 rounded-xl border-2 bg-white overflow-hidden transition-all ${
                      i === fotoAtivaSegura
                        ? 'border-brand-accent-600 shadow-sm'
            ...
            <div className="grid grid-cols-3 gap-3">
              {[
                { icon: Shield, color: 'text-primary-blue', bg: 'bg-primary-blue/5', t: 'Garantia', s: 'Do fabricante' },
                { icon: Award, color: 'text-brand-accent-300', bg: 'bg-amber-50', t: 'Homologado', s: 'Zoom, Teams e Meet' },
                { icon: Leaf, color: 'text-emerald-500', bg: 'bg-emerald-50', t: 'Nota Fiscal', s: 'Em todo pedido' },
              ].map((seal) => (
              ...
              <div className="bg-gradient-to-br from-gray-50 to-white p-5 rounded-2xl border border-gray-150/70 space-y-3">
                ...
                <div className="flex items-end justify-between gap-3">
                  <div className="flex items-baseline gap-1.5">
                    <span className={`text-4xl font-black tracking-tight ${hasDiscount ? 'text-brand-accent-600' : 'text-brand-ink'}`}>
                    ...
                    <div className="p-4 bg-emerald-50/60 border border-emerald-100 rounded-2xl space-y-2.5">
                      ...
                      */}
                      ...
                      <p className="text-[11px] text-gray-500 leading-normal pt-1">
                        Equipamento óptico e eletrônico segue com embalagem reforçada. O valor
              ...
              >
                {activeTab === 'ficha' && (
                  <div className="space-y-4 max-w-3xl">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-2">
                      ...
                      <div className="bg-gray-50 p-4 rounded-xl border border-gray-150/40">
                        <span className="text-[11px] text-gray-400 block font-medium uppercase tracking-wider">Garantia</span>
                        <span className="text-sm text-gray-800 font-bold">Do fabricante</span>
                      </div>
                      <div className="bg-gray-50 p-4 rounded-xl border border-gray-150/40">
                        <span className="text-[11px] text-gray-400 block font-medium uppercase tracking-wider">Marca</span>
                        <span className="text-sm text-gray-800 font-bold">Macsym</span>
                      </div>
                      <div className="bg-gray-50 p-4 rounded-xl border border-gray-150/40">
                ...
                {activeTab === 'garantias' && (
                  <div className="space-y-4 max-w-3xl">
                    ...
                    <ul className="text-sm text-gray-600 leading-relaxed bg-gray-50 p-4 rounded-xl border border-gray-150/40 space-y-2 list-disc list-inside">
                      <li>Garantia do fabricante e nota fiscal em todo pedido.</li>
                      <li>Compatibilidade declarada com Zoom, Teams, Meet, WebEx, OBS e vMix.</li>
                      <li>Protocolos abertos: VISCA, PELCO-D/P, ONVIF, NDI e RTSP.</li>
                      <li>Troca e devolução em até 7 dias do recebimento.</li>
                    </ul>
                    <div className="flex items-start gap-2.5 text-[13px] text-amber-700 bg-amber-50 rounded-xl p-4 border border-amber-100">
                      ...
                      <span>Para faturamento com CNPJ pode haver diferencial de alíquota de ICMS ou substituição tributária — consulte antes de finalizar.</span>
                    </div>
                  </div>
                )}
                ...
                {activeTab === 'cuidados' && (
                  <div className="space-y-4 max-w-3xl">
                    ...
                    <ul className="text-sm text-gray-600 leading-relaxed bg-gray-50 p-4 rounded-xl border border-gray-150/40 space-y-2 list-disc list-inside">
                      {/*
                        PENDENTE: instruções gerais de instalação e conservação.
                        Confirmar com a Macsym o que vale por linha de produto —
                        câmera PTZ, microfone sem fio e mesa controladora pedem
                        cuidados diferentes, e uma orientação errada aqui custa
                        equipamento.
                      */}
                      <li>Limpe a lente apenas com pano de microfibra seco, sem álcool ou solvente.</li>
                      <li>
                        Câmeras PTZ: <strong>não gire o corpo com a mão</strong> — use o controle
                        remoto, o software ou a mesa controladora.
                      </li>
                      <li>
                        Alimentação: use a fonte que acompanha o produto. Em PoE, confira a classe
                        exigida pelo modelo antes de ligar no switch.
                      </li>
                      <li>
                        Microfones sem fio: retire as pilhas ou carregue o estojo antes de guardar
                        por longos períodos.
                      </li>
                    </ul>
                  </div>
