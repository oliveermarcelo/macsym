 ...
 * em 2026-09-22. Editar à mão aqui só faz sentido
...
export const MENU_CATEGORIES: MenuCategory[] = [
  ...
  },
  {
    ...
    subcategories: [
      {
        id: "camera-360-graus",
        name: "Câmera 360 Graus"
      },
      {
        id: "al-face-tracking",
        name: "Al Face Tracking"
      },
      {
        id: "resolucao-4k-webcam",
        name: "Resolução 4k"
      },
      {
        id: "resolucao-2k-webcam",
        name: "Resolução 2k"
      },
      {
        id: "resolucao-1080p-webcam",
        name: "Resolução 1080P"
      },
      {
        id: "auto-falante-embutido",
        name: "Auto Falante Embutido"
      },
      {
        id: "auto-foco",
        name: "Auto Foco"
      ...
      {
        id: "microfone-embutido",
        name: "Microfone Embutido"
      },
      {
        id: "saida-de-video-usb",
        name: "Saída de vídeo USB"
      }
    ]
  },
  {
  ...
  },
  {
    ...
    subcategories: [
      ...
      {
        id: "auto-tracking-movimento",
        name: "Auto Tracking Movimento"
      },
      {
        id: "auto-tracking-speaker",
        name: "Auto Tracking Speaker"
      },
      {
        id: "entrada-de-audio",
      ...
      {
        id: "protocolos-hx-hx3",
        name: "Protocolos HX/HX3"
      },
      {
        id: "saida-hdmi",
        name: "Saída HDMI"
    ...
    subcategories: [
      {
        ...
        name: "Lapela 1 Microfone"
      },
      {
        id: "lapela-2-microfone",
        name: "Lapela 2 Microfone"
      },
      {
        id: "microfone-de-mesa",
        name: "Microfone de Mesa"
      },
      {
        id: "sem-fio",
        name: "Sem Fio"
      ...
      {
        id: "microfone-p-camera-dlsr",
        name: "Microfone p/ Câmera DLSR"
      },
      {
        id: "boya",
        name: "Boya"
      ...
      {
        id: "conexao-com-fio-lightning",
        name: "Conexão com fio Lightning"
      },
      {
        id: "conexao-com-fio-p2",
        name: "Conexão com fio P2"
      },
      {
        id: "conexao-com-fio-usb-c",
        name: "Conexão com fio USB C"
      },
      {
        id: "conexao-com-fio-xrl",
        name: "Conexão com fio XRL"
      },
      {
        id: "conexao-sem-fio-2-4ghz",
        name: "Conexão sem fio 2.4GHz"
      },
      {
        id: "conexao-sem-fio-uhf",
        name: "Conexão sem fio UHF"
      },
      {
        id: "ios",
        name: "IOS"
      ...
      {
        id: "microfone-p-braco-articulado",
        name: "Microfone p/ Braço Articulado"
      },
      {
...
export const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    longDescription: "Descrição FATURAMENTO PARA CNPJ PODE EXISTIR A INCIDÊNCIA DE DIFERENCIAL DE ALÍQUOTA DE ICMS OU SUBSTITUIÇÃO TRIBUTÁRIA. POR FAVOR USE A ÁREA DE PERGUNTAS PARA ESCLARECIMENTOS ANTES DE REALIZAR A COMPRA. Suporte de parede para câmeras PTZ de videoconferência com PARAFUSOS e BUCHAS para montagem. Fabricada em chapa de aço de 3mm com pintura eletrostática preta suporta câmeras com peso igual ou inferior a 5 Kg Esta oferta inclui: * 1 Suporte para câmera PTZ em aço * 4 Parafusos para bucha de parede * 4 Arruelas * 4 Buchas de Nylon Fischer UX 6mm * 4 Protetores Batente Gota De Silicone Adesivo 13×8,0mm * 1 Manipulo Botão Termoplástico Rosca 1/4 × 15mm Dimensões: Largura : 150 mm Altura: 132 mm Profundidade : 188 mm Oblongo para fixação da câmera : 55 x 7 mm Peso do suporte : 1Kge : 1Kg Garantia do vendedor: 12 meses",
    price: 180.4,
  ...
  },
  {
    ...
    subcategories: [
      ...
      "auto-foco",
      "microfone-embutido",
      "resolucao-1080p-webcam",
      "resolucao-4k-webcam",
      "saida-de-video-usb"
    ],
    categoryLabel: "Câmera 360 Graus",
  ...
  },
  {
    ...
    categoryLabel: "Al Face Tracking",
  ...
  },
  {
    ...
    subcategories: [
      ...
      "boya",
      "com-fio",
      "conexao-com-fio-usb-c",
      "tipo-c"
    ],
    categoryLabel: "Microfone de Mesa",
  ...
  },
  {
    ...
    categoryLabel: "Lapela 2 Microfone",
  ...
  },
  {
    ...
    subcategories: [
      ...
      "audio-e-video",
      "boya",
      "conexao-com-fio-lightning",
      "conexao-sem-fio-2-4ghz",
      "ios",
      "sem-fio",
      "wireless"
    ],
    categoryLabel: "Lapela 1 Microfone",
