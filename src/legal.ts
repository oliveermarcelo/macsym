...
const EMAIL = 'contato@camerasdevideo.com.br';
  ...
  sections: [
    {
      heading: '',
      blocks: [
        p('Antonela Bordon, pessoa jurídica de direito privado, descreve, através deste documento, as regras de uso do site camerasdevideo.com.br e qualquer outro site, loja ou aplicativo operado pelo proprietário.'),
